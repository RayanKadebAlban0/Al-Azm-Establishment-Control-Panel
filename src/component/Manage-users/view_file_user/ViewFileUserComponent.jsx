  ...
  return (
    ...
    <Styles addCross={addCross}>
      ...
      {/* <div className="container_extra">
        <div className="container_column">
          <div>
            <h4 className="title"> الملاحظات الإعلامية</h4>
            <BaseDataTable
              columns={columnNote}
              data={dataTable}
              className="table_activite"
          ...
          <div>
            <h4 className="title"> سجلات التقييم الإضافية</h4>
            <BaseDataTable
              columns={columnValuation}
              data={dataTable}
              className="table_activite"
              customStyles={customStyles}
            />
        ...
        <div className="add_note_or_valuation">
          <div className="container_label">
            
          <label className={`button ${addValuation ? "activite" : ""}`}>
            <input
              type="radio"
              value={addValuation}
              checked={addValuation === true}
              onChange={(e) => {
                handleAddvaluation();
              }}
            />
            ...
            <label className={`button ${addNote ? "activite" : ""}`}>
            <input
              type="radio"
              value={addNote}
              checked={addNote === true}
              onChange={(e) => {
                handleAddNote();
              }}
            />
          ...
          <div className="content">
            <div className="container_option">
              {addValuation?( <>
                <CustomChecked data={options} />
         <button className="button_add_valuation">
            <span>+</span>
            <b> إضافة التقييم</b>
          </button>
          <textarea placeholder="اكتب تقييم جديد"  className="text_area"/>
          </>):(<>
          <textarea placeholder={`اكتب ملاحظة جديدة عن `}  className="text_area"/>
         <input placeholder="اكتب اسم النشاط إن وجد" className="input_note"/> 
        <input placeholder="اكتب تاريخ الملاحظة" className="input_note"/> 
