...
export const routes = [
    ...
    {
        path: "/viewFileUser",
        element: <ViewFileUser />
    },
    {
        path: "/viewFileUser/:id",
        element: <ViewFileUser />
    },
    {
        path: "/DetailsActivite/:id",
        element: <DetailsAtivite />
    },
    {
        path: "/requirmentUnactivite",
        element: <RequirmentUnactivite />
    },
    {
        path: "/editActivite/:id",
        element: <EditActivite />
    },
    {
        path: "/confirm",
        element: <Confirm />
    ...
    {
        path: "/adminPersinality",
        element: <AdminPersonality />
    },
    {
        path: "/addAdminOrCrrentAdmin",
        element: <AddAdminOrCurrentAdmin />
    },
    {
        path: "/addActivite",
        element: <AddActivite />
